...
<html lang="vi">
<head>
    <title>Tạo Audio học tiếng anh - Web5Ngay.Com</title> 
...
<body> 
 ...
 <div class="row"> 
  ...
  <div class="form-group">
    <label for="id">Chọn mẫu câu muốn học</label>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div style="margin: 0px; padding: 10px;border: 2px dashed #ff4500;"> 
      <p class="sold_out">Phương pháp học tại Video: <a href='https://www.youtube.com/watch?v=R_oMvB80Vjw'> Video này </a></p>
      <p class="sold_out">Tham gia Group Web5ngay: <a href='https://www.facebook.com/groups/2142377209324098/'> Link này </a></p>
      <p class="sold_out">Cần hỗ trợ / báo lỗi <a href='https://www.facebook.com/100003990309362'> Facebook này </a></p> 
      <p><font color='red'>Mời tớ 1 ly cà phê ☕️ qua Momo / ZaloPay: 0905692090 ♥️</font></p> 
    </div> 
